// <summary>Implémentation de la classe <c>Crypt.Encoders.Sha512Encoder</c>.</summary>
...
namespace Crypt.Encoders {
  ...
  /// <summary>Représente la méthode de codage SHA-512.</summary>
  public class Sha512Encoder: IStringEncoder {
  
    /// <summary>Initialise une nouvelle instance de la classe <see cref="Sha512Encoder" />.</summary>
